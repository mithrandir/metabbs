...
function get_header_path() {
	global $view, $config;
	if ($view == ADMIN_VIEW)
		return METABBS_DIR .'/themes/default/admin_header.php';
	else
		return $config->get('global_header', METABBS_DIR .'/themes/default/default_header.php');
}
function get_footer_path() {
	global $view, $config;
	if ($view == ADMIN_VIEW)
		return METABBS_DIR .'/themes/default/admin_footer.php';
	else
		return $config->get('global_footer', METABBS_DIR .'/themes/default/default_footer.php');
}
