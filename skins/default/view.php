...
<? foreach ($trackbacks as $trackback) { ?>
	<li><?=link_text($trackback->url, $trackback->title)?> from <?=$trackback->blog_name?> <? if ($account->has_perm('moderate')) { echo link_with_dialog_to('<strong>X</strong>', $trackback, 'delete'); } ?></li>
<? } ?>
</ul>
</div>
<? } ?>
