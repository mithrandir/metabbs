...
<div id="header">
    <p><a href="?action=index">Boards</a> | <a href="?action=users">Users</a> | <a href="?action=settings">Settings</a> | <a href="metabbs.php/user/logout?url=<?=get_base_path()?>admin.php">Logout &raquo;</a></p>
</div>
<div id="body">
<? if (isset($flash)) { ?>
