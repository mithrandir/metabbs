...
<table id="post">
<tr>
	<th>이름</th><td><input type="text" name="name" class="text" size="12" value="{$article->name}" /></td>
</tr>
<tr>
	<th>암호</th><td><input type="password" name="passwd" class="text" size="12" /></td>
</tr>
<tr>
	<th>제목</th><td class="subject"><input type="text" name="subject" class="text" size="60" value="{$article->subject}" /></td>
</tr>
<tr>
	<td colspan="2">
...
{if isset($id)}
	<li><a href="{$article->getURL($page)}">돌아가기</a></li>
{/if}
