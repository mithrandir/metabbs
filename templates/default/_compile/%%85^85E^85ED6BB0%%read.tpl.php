<?php /* Smarty version 2.6.6, created on 2005-01-22 09:19:09
...
<span id="article-info">Posted by <?php echo ((is_array($_tmp=$this->_tpl_vars['article']->name)) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
" onload="this.style.marginTop = ((this.height<100)?(100-this.height)/2:0)+'px';" /></div><?php else: ?><small>Download: </small><br /><a href="download.php?fileid=<?php echo $this->_tpl_vars['attachment']->fileid; ?>
...
" id="cmt-form">
	<p>Name: <input type="text" name="name" class="text" size="10" tabindex="1" value="<?php echo $this->_tpl_vars['cache_name']; ?>
" /><span style="padding: 0 10px">Password: <input type="password" name="passwd" class="text" size="10" tabindex="2" /></span> <input type="submit" value="Post" class="submit" accesskey="s" tabindex="4" /></p>
