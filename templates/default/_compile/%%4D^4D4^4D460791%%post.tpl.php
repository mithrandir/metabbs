<?php /* Smarty version 2.6.6, created on 2005-01-18 19:01:53
...
<table id="post">
<tr>
	<th>Name</th><td><input type="text" name="name" class="text" size="12" value="<?php echo $this->_tpl_vars['article']->name; ?>
" /></td>
</tr>
<tr>
...
<tr>
	<th>Subject</th><td class="subject"><input type="text" name="subject" class="text" size="60" value="<?php echo $this->_tpl_vars['article']->subject; ?>
" /></td>
</tr>
<tr>
	<td colspan="2">
...
<input type="submit" value="<?php if (isset ( $this->_tpl_vars['id'] )): ?>Edit<?php else: ?>Post<?php endif; ?>" class="submit" accesskey="s" />
</form>
