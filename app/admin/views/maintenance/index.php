<form method="get" action="<?=url_admin_for('maintenance', 'backup')?>" id="backup">
<h2><?=i('Backup')?></h2>
...
<form method="post" action="<?=url_admin_for('maintenance', 'restore')?>" enctype="multipart/form-data" id="restore">
<?=form_token_field()?>
<h2><?=i('Restore')?></h2>
...
<form method="post" action="<?=url_admin_for('maintenance', 'purge-session')?>" id="purge-session">
<?=form_token_field()?>
<h2>세션 정리</h2>
...
<form method="post" action="<?=url_admin_for('maintenance', 'uninstall')?>" id="uninstall">
<?=form_token_field()?>
<h2><?=i('Uninstall')?></h2>
