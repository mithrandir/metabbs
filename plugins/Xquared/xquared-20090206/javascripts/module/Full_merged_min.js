...
},getTableProperty:function(){var A={width:this.table.style.width||"auto",height:this.table.style.height||"auto",textAlign:this.table.style.textAlign||"",borderColor:this.table.style.borderLeftColor||"",borderWidth:this.table.style.borderLeftWidth.replace(/ .*/,"").replace(/[^0-9]/g,"")||"0",backgroundColor:this.table.style.backgroundColor||"transparent"};
return A
},setTableProperty:function(A){this._setTableProperty(this.table,A)
},getRowProperty:function(A){var B={height:A.style.height||"auto",verticalAlign:A.style.verticalAlign||"",textAlign:A.style.textAlign||"",backgroundColor:A.style.backgroundColor||"transparent"};
return B
},setRowProperty:function(A,B){this._setTableProperty(A,B)
},getColumnProperty:function(A){var B={width:A.style.width||"auto",verticalAlign:A.style.verticalAlign||"",textAlign:A.style.textAlign||"",backgroundColor:A.style.backgroundColor||"transparent"};
return B
...
}},_setTableProperty:function(A,B){if(typeof B.width!="undefined"){A.style.width=(typeof B.width=="string"?B.width:B.width.size+B.width.unit)||""
}if(typeof B.height!="undefined"){A.style.height=(typeof B.height=="string"?B.height:B.height.size+B.height.unit)||""
}if(typeof B.textAlign!="undefined"){A.style.textAlign=B.textAlign||""
}if(typeof B.verticalAlign!="undefined"){A.style.verticalAlign=B.verticalAlign||""
}if(typeof B.borderColor!="undefined"){A.style.borderColor=B.borderColor||""
}if(typeof B.borderWidth!="undefined"){A.style.borderWidth=B.borderWidth+"px"||"";
if(B.borderWidth>0){A.style.borderStyle="solid"
}}if(typeof B.fixed!="undefined"){A.style.tableLayout="fixed"
}if(typeof B.backgroundColor!="undefined"){A.style.backgroundColor=B.backgroundColor||""
}if(typeof B.className!="undefined"){A.className=B.className||""
...
D.position=D.position||"centerOfWindow";
D.mode=D.mode||"modal";
D.cancelOnEsc=D.cancelOnEsc||true;
var B=this;
var A=document.createElement("DIV");
...
var H=0;
document.title=E;
if(E==="centerOfWindow"){F=document.documentElement||document.body;
B+=F.scrollLeft;
H+=F.scrollTop
...
A.appendChild(E);
if(B.list){this._createDropdown(B,E)
}else{this._createButton(B,E)
...
return A
},_createDropdown:function(A,I){var B=this._createButton(A,I);
B.items=A.list;
...
var G=this.doc.createElement("H3");
G.innerHTML=A.title;
F.appendChild(G);
var H=this.doc.createElement("DIV");
H.className="dialog-content";
...
J.appendChild(C);
if(K.html){C.innerHTML=K.html
}C.href="#";
C.handler=K.handler;
for(attr in K.style){C.style[attr]=K.style[attr]
}xq.observe(C,"mousedown",xq.cancelHandler);
xq.observe(C,"mouseup",this._closeAllLightweight.bindAsEventListener(this));
xq.observe(C,"click",this._clickHandler.bindAsEventListener(this));
E.appendChild(J)
}H.appendChild(E);
F.appendChild(H);
this.dialogContainer.appendChild(F);
I.appendChild(B)
},_openDropdownDialog:function(B){this._closeAllLightweight();
var C=B.target||B.srcElement;
var A=document.getElementById(C.className+"Dialog");
if(A){A.style.display="block";
A.style.top=this.container.offsetHeight+"px";
A.style.left=C.parentNode.offsetLeft+"px"
}xq.stopEvent(B);
return false
},_closeAllLightweight:function(){var B=this.dialogContainer.childNodes;
for(var A=0;
A<B.length;
...
this.config.defaultToolbarButtonGroups={color:[{className:"foregroundColor",title:"Foreground color",list:[{style:{backgroundColor:"#ffd8d8"},handler:"xed.handleForegroundColor('#ffd8d8')"},{style:{backgroundColor:"#ffead9"},handler:"xed.handleForegroundColor('#ffead9')"},{style:{backgroundColor:"#fef2dc"},handler:"xed.handleForegroundColor('#fef2dc')"},{style:{backgroundColor:"#fff5da"},handler:"xed.handleForegroundColor('#fff5da')"},{style:{backgroundColor:"#eefed9"},handler:"xed.handleForegroundColor('#eefed9')"},{style:{backgroundColor:"#dafeda"},handler:"xed.handleForegroundColor('#dafeda')"},{style:{backgroundColor:"#d8ffff"},handler:"xed.handleForegroundColor('#d8ffff')"},{style:{backgroundColor:"#d9f7ff"},handler:"xed.handleForegroundColor('#d9f7ff')"},{style:{backgroundColor:"#d5ebff"},handler:"xed.handleForegroundColor('#d5ebff')"},{style:{backgroundColor:"#eed8ff"},handler:"xed.handleForegroundColor('#eed8ff')"},{style:{backgroundColor:"#fed8ff"},handler:"xed.handleForegroundColor('#fed8ff')"},{style:{backgroundColor:"#ffffff"},handler:"xed.handleForegroundColor('#ffffff')"},{style:{backgroundColor:"#fe8c8c"},handler:"xed.handleForegroundColor('#fe8c8c')"},{style:{backgroundColor:"#feba8d"},handler:"xed.handleForegroundColor('#feba8d')"},{style:{backgroundColor:"#ffe88b"},handler:"xed.handleForegroundColor('#ffe88b')"},{style:{backgroundColor:"#ffff8d"},handler:"xed.handleForegroundColor('#ffff8d')"},{style:{backgroundColor:"#d0fc8d"},handler:"xed.handleForegroundColor('#d0fc8d')"},{style:{backgroundColor:"#8efb8e"},handler:"xed.handleForegroundColor('#8efb8e')"},{style:{backgroundColor:"#8bffff"},handler:"xed.handleForegroundColor('#8bffff')"},{style:{backgroundColor:"#8ce8ff"},handler:"xed.handleForegroundColor('#8ce8ff')"},{style:{backgroundColor:"#8b8cff"},handler:"xed.handleForegroundColor('#8b8cff')"},{style:{backgroundColor:"#d18cff"},handler:"xed.handleForegroundColor('#d18cff')"},{style:{backgroundColor:"#ff8bfe"},handler:"xed.handleForegroundColor('#ff8bfe')"},{style:{backgroundColor:"#cccccc"},handler:"xed.handleForegroundColor('#cccccc')"},{style:{backgroundColor:"#ff0103"},handler:"xed.handleForegroundColor('#ff0103')"},{style:{backgroundColor:"#ff6600"},handler:"xed.handleForegroundColor('#ff6600')"},{style:{backgroundColor:"#ffcc01"},handler:"xed.handleForegroundColor('#ffcc01')"},{style:{backgroundColor:"#ffff01"},handler:"xed.handleForegroundColor('#ffff01')"},{style:{backgroundColor:"#96f908"},handler:"xed.handleForegroundColor('#96f908')"},{style:{backgroundColor:"#07f905"},handler:"xed.handleForegroundColor('#07f905')"},{style:{backgroundColor:"#02feff"},handler:"xed.handleForegroundColor('#02feff')"},{style:{backgroundColor:"#00ccff"},handler:"xed.handleForegroundColor('#00ccff')"},{style:{backgroundColor:"#0100fe"},handler:"xed.handleForegroundColor('#0100fe')"},{style:{backgroundColor:"#9801ff"},handler:"xed.handleForegroundColor('#9801ff')"},{style:{backgroundColor:"#fc01fe"},handler:"xed.handleForegroundColor('#fc01fe')"},{style:{backgroundColor:"#999999"},handler:"xed.handleForegroundColor('#999999')"},{style:{backgroundColor:"#990002"},handler:"xed.handleForegroundColor('#990002')"},{style:{backgroundColor:"#b65006"},handler:"xed.handleForegroundColor('#b65006')"},{style:{backgroundColor:"#bf7900"},handler:"xed.handleForegroundColor('#bf7900')"},{style:{backgroundColor:"#cca500"},handler:"xed.handleForegroundColor('#cca500')"},{style:{backgroundColor:"#5a9603"},handler:"xed.handleForegroundColor('#5a9603')"},{style:{backgroundColor:"#059502"},handler:"xed.handleForegroundColor('#059502')"},{style:{backgroundColor:"#009997"},handler:"xed.handleForegroundColor('#009997')"},{style:{backgroundColor:"#007998"},handler:"xed.handleForegroundColor('#007998')"},{style:{backgroundColor:"#095392"},handler:"xed.handleForegroundColor('#095392')"},{style:{backgroundColor:"#6a19a4"},handler:"xed.handleForegroundColor('#6a19a4')"},{style:{backgroundColor:"#98019a"},handler:"xed.handleForegroundColor('#98019a')"},{style:{backgroundColor:"#666666"},handler:"xed.handleForegroundColor('#666666')"},{style:{backgroundColor:"#590100"},handler:"xed.handleForegroundColor('#590100')"},{style:{backgroundColor:"#773505"},handler:"xed.handleForegroundColor('#773505')"},{style:{backgroundColor:"#7f5000"},handler:"xed.handleForegroundColor('#7f5000')"},{style:{backgroundColor:"#927300"},handler:"xed.handleForegroundColor('#927300')"},{style:{backgroundColor:"#365802"},handler:"xed.handleForegroundColor('#365802')"},{style:{backgroundColor:"#035902"},handler:"xed.handleForegroundColor('#035902')"},{style:{backgroundColor:"#01595a"},handler:"xed.handleForegroundColor('#01595a')"},{style:{backgroundColor:"#00485b"},handler:"xed.handleForegroundColor('#00485b')"},{style:{backgroundColor:"#083765"},handler:"xed.handleForegroundColor('#083765')"},{style:{backgroundColor:"#370159"},handler:"xed.handleForegroundColor('#370159')"},{style:{backgroundColor:"#59005a"},handler:"xed.handleForegroundColor('#59005a')"},{style:{backgroundColor:"#000000"},handler:"xed.handleForegroundColor('#000000')"}]},{className:"backgroundColor",title:"Background color",list:[{style:{backgroundColor:"#FFF700"},handler:"xed.handleBackgroundColor('#FFF700')"},{style:{backgroundColor:"#AEFF66"},handler:"xed.handleBackgroundColor('#AEFF66')"},{style:{backgroundColor:"#FFCC66"},handler:"xed.handleBackgroundColor('#FFCC66')"},{style:{backgroundColor:"#DCB0FB"},handler:"xed.handleBackgroundColor('#DCB0FB')"},{style:{backgroundColor:"#B0EEFB"},handler:"xed.handleBackgroundColor('#B0EEFB')"},{style:{backgroundColor:"#FBBDB0"},handler:"xed.handleBackgroundColor('#FBBDB0')"},{style:{backgroundColor:"#FFFFFF"},handler:"xed.handleBackgroundColor('#FFFFFF')"}]}],font:[{className:"fontFace",title:"Font face",list:[{html:"Arial",style:{fontFamily:"Arial"},handler:"xed.handleFontFace('Arial')"},{html:"Comic Sans MS",style:{fontFamily:"Comic Sans MS"},handler:"xed.handleFontFace('Comic Sans MS')"},{html:"Courier New",style:{fontFamily:"Courier New"},handler:"xed.handleFontFace('Courier New')"},{html:"Georgia",style:{fontFamily:"Georgia"},handler:"xed.handleFontFace('Georgia')"},{html:"Tahoma",style:{fontFamily:"Tahoma"},handler:"xed.handleFontFace('Tahoma')"},{html:"Times",style:{fontFamily:"Times"},handler:"xed.handleFontFace('Times')"},{html:"Trebuchte MS",style:{fontFamily:"Trebuchte MS"},handler:"xed.handleFontFace('Trebuchte MS')"},{html:"Verdana",style:{fontFamily:"Verdana"},handler:"xed.handleFontFace('Verdana')"}]},{className:"fontSize",title:"Font size",list:[{html:"Lorem ipsum dolor (8pt)",style:{fontSize:"8pt",marginBottom:"3px"},handler:"xed.handleFontSize('1')"},{html:"Lorem ipsum dolor (10pt)",style:{fontSize:"10pt",marginBottom:"3px"},handler:"xed.handleFontSize('2')"},{html:"Lorem ipsum dolor (12pt)",style:{fontSize:"12pt",marginBottom:"6px"},handler:"xed.handleFontSize('3')"},{html:"Lorem ipsum dolor (14pt)",style:{fontSize:"14pt",marginBottom:"10px"},handler:"xed.handleFontSize('4')"},{html:"Lorem ipsum dolor (18pt)",style:{fontSize:"18pt",marginBottom:"16px"},handler:"xed.handleFontSize('5')"},{html:"Lorem ipsum dolor (24pt)",style:{fontSize:"24pt",marginBottom:"6px"},handler:"xed.handleFontSize('6')"}]}],link:[{className:"link",title:"Link",handler:"xed.handleLink()"},{className:"removeLink",title:"Remove link",handler:"xed.handleRemoveLink()"}],style:[{className:"strongEmphasis",title:"Strong emphasis",handler:"xed.handleStrongEmphasis()"},{className:"emphasis",title:"Emphasis",handler:"xed.handleEmphasis()"},{className:"underline",title:"Underline",handler:"xed.handleUnderline()"},{className:"strike",title:"Strike",handler:"xed.handleStrike()"},{className:"superscription",title:"Superscription",handler:"xed.handleSuperscription()"},{className:"subscription",title:"Subscription",handler:"xed.handleSubscription()"},{className:"removeFormat",title:"Remove format",handler:"xed.handleRemoveFormat()"}],justification:[{className:"justifyLeft",title:"Justify left",handler:"xed.handleJustify('left')"},{className:"justifyCenter",title:"Justify center",handler:"xed.handleJustify('center')"},{className:"justifyRight",title:"Justify right",handler:"xed.handleJustify('right')"},{className:"justifyBoth",title:"Justify both",handler:"xed.handleJustify('both')"}],indentation:[{className:"indent",title:"Indent",handler:"xed.handleIndent()"},{className:"outdent",title:"Outdent",handler:"xed.handleOutdent()"}],block:[{className:"paragraph",title:"Paragraph",handler:"xed.handleApplyBlock('P')"},{className:"heading1",title:"Heading 1",list:[{html:"Heading1",style:{fontSize:"2.845em",marginBottom:"3px"},handler:"xed.handleApplyBlock('H1')"},{html:"Heading2",style:{fontSize:"2.46em",marginBottom:"3px"},handler:"xed.handleApplyBlock('H2')"},{html:"Heading3",style:{fontSize:"2.153em",marginBottom:"3px"},handler:"xed.handleApplyBlock('H3')"},{html:"Heading4",style:{fontSize:"1.922em",marginBottom:"3px"},handler:"xed.handleApplyBlock('H4')"},{html:"Heading5",style:{fontSize:"1.461em",marginBottom:"3px"},handler:"xed.handleApplyBlock('H5')"},{html:"Heading6",style:{fontSize:"1.23em",marginBottom:"3px"},handler:"xed.handleApplyBlock('H6')"}]},{className:"blockquote",title:"Blockquote",handler:"xed.handleApplyBlock('BLOCKQUOTE')"},{className:"code",title:"Code",handler:"xed.handleList('OL', 'code')"},{className:"division",title:"Division",handler:"xed.handleApplyBlock('DIV')"},{className:"unorderedList",title:"Unordered list",handler:"xed.handleList('UL')"},{className:"orderedList",title:"Ordered list",handler:"xed.handleList('OL')"}],insert:[{className:"table",title:"Table",handler:"xed.handleTable({'rows':4, 'cols':4, 'headerPositions':'tl'})"},{className:"separator",title:"Separator",handler:"xed.handleSeparator()"},{className:"emoticon",title:"Emoticon",list:[{html:"<img src='../images/dialogs/emoticon/num1.gif' />",handler:"xed.handleEmoticon('num1.gif')"},{html:"<img src='../images/dialogs/emoticon/num2.gif' />",handler:"xed.handleEmoticon('num2.gif')"},{html:"<img src='../images/dialogs/emoticon/num3.gif' />",handler:"xed.handleEmoticon('num3.gif')"},{html:"<img src='../images/dialogs/emoticon/num4.gif' />",handler:"xed.handleEmoticon('num4.gif')"},{html:"<img src='../images/dialogs/emoticon/num5.gif' />",handler:"xed.handleEmoticon('num5.gif')"},{html:"<img src='../images/dialogs/emoticon/question.gif' />",handler:"xed.handleEmoticon('question.gif')"},{html:"<img src='../images/dialogs/emoticon/disk.gif' />",handler:"xed.handleEmoticon('disk.gif')"},{html:"<img src='../images/dialogs/emoticon/play.gif' />",handler:"xed.handleEmoticon('play.gif')"},{html:"<img src='../images/dialogs/emoticon/flag1.gif' />",handler:"xed.handleEmoticon('flag1.gif')"},{html:"<img src='../images/dialogs/emoticon/flag2.gif' />",handler:"xed.handleEmoticon('flag2.gif')"},{html:"<img src='../images/dialogs/emoticon/flag3.gif' />",handler:"xed.handleEmoticon('flag3.gif')"},{html:"<img src='../images/dialogs/emoticon/flag4.gif' />",handler:"xed.handleEmoticon('flag4.gif')"},{html:"<img src='../images/dialogs/emoticon/arrow_left.gif' />",handler:"xed.handleEmoticon('arrow_left.gif')"},{html:"<img src='../images/dialogs/emoticon/arrow_right.gif' />",handler:"xed.handleEmoticon('arrow_right.gif')"},{html:"<img src='../images/dialogs/emoticon/arrow_up.gif' />",handler:"xed.handleEmoticon('arrow_up.gif')"},{html:"<img src='../images/dialogs/emoticon/arrow_down.gif' />",handler:"xed.handleEmoticon('arrow_down.gif')"},{html:"<img src='../images/dialogs/emoticon/step1.gif' />",handler:"xed.handleEmoticon('step1.gif')"},{html:"<img src='../images/dialogs/emoticon/step2.gif' />",handler:"xed.handleEmoticon('step2.gif')"},{html:"<img src='../images/dialogs/emoticon/step3.gif' />",handler:"xed.handleEmoticon('step3.gif')"},{html:"<img src='../images/dialogs/emoticon/note.gif' />",handler:"xed.handleEmoticon('note.gif')"},{html:"<img src='../images/dialogs/emoticon/heart.gif' />",handler:"xed.handleEmoticon('heart.gif')"},{html:"<img src='../images/dialogs/emoticon/good.gif' />",handler:"xed.handleEmoticon('good.gif')"},{html:"<img src='../images/dialogs/emoticon/bad.gif' />",handler:"xed.handleEmoticon('bad.gif')"}]}]};
...
}else{if("focus"==e.type){this.toolbar._closeAllLightweight();
...
}A.show({position:"centerOfEditor",mode:"lightweight"});
return true
...
}else{if(C&&C.className&&C.className.match(/datatable/)&&!A){this.handleMoveToNextCell()
...
}else{if(C&&C.className&&C.className.match(/datatable/)&&!A){this.handleMoveToPreviousCell()
...
this._fireOnCurrentContentChanged(this);
return true
},handleTable:function(B){var F=this.rdom.getCurrentBlockElement();
if(!F){F=this.getBody()
...
xq.macro={};
xq.macro.Base=xq.Class({initialize:function(C,B,A){this.id=C;
this.placeHolderImgSrc=A;
if(typeof B==="string"){this.html=B;
this.params={};
this.initFromHtml()
}else{this.html=null;
this.params=B;
this.initFromParams()
}},initFromHtml:function(){},initFromParams:function(){},createHtml:function(){throw"Not implemented"
},onLayerInitialzied:function(A){},createPlaceHolderHtml:function(){var A={width:5,height:5};
var B={};
B.id=this.id;
...
sb.push('width="'+(A.width+4)+'" height="'+(A.height+4)+'" ');
sb.push('longdesc="'+escape(JSON.stringify(B))+'" ');
sb.push('style="border: 1px solid #ccc" ');
sb.push("/>");
return sb.join("")
}});
xq.macro.Factory=xq.Class({initialize:function(A){this.placeHolderImgSrc=A;
this.macroClazzes={}
},register:function(B){var A=xq.macro[B+"Macro"];
if(!A){throw"Unknown macro id: ["+B+"]"
}this.macroClazzes[B]=A
},createMacroFromHtml:function(B){for(var C in this.macroClazzes){var A=this.macroClazzes[C];
if(A.recognize(B)){return new A(C,B,this.placeHolderImgSrc)
}}return null
},createMacroFromDefinition:function(B){var A=this.macroClazzes[B.id];
if(!A){return null
}return new A(B.id,B.params,this.placeHolderImgSrc)
}});
xq.Layer=xq.Class({initialize:function(C,B,A){xq.addToFinalizeQueue(this);
this.margin=4;
this.editor=C;
this.element=B;
...
this.doc=C._createDoc(this.frame,'<style type="text/css">html, body {margin:0px; padding:0px; background-color: transparent; width: 100%; height: 100%; overflow: hidden;}</style>',[],null,null,A);
this.frame.style.position="absolute";
this.updatePosition()
},getFrame:function(){return this.frame
},getDoc:function(){return this.doc
},getBody:function(){return this.doc.body
},isValid:function(){return this.element&&this.element.parentNode&&this.element.offsetParent
},detach:function(){this.frame.parentNode.removeChild(this.frame);
this.frame=null;
this.element=null
},updatePosition:function(){var E=xq.getCumulativeOffset(this.element,this.editor.rdom.getRoot());
var D=this.editor.getDoc();
var A=this.editor.getBody();
E.left-=D.documentElement.scrollLeft+A.scrollLeft-this.margin;
E.top-=D.documentElement.scrollTop+A.scrollTop-this.margin;
this.frame.style.left=E.left+"px";
this.frame.style.top=E.top+"px";
var C=this.doc.body.scrollWidth+(this.margin-1)*2;
var B=this.doc.body.scrollHeight+(this.margin-1)*2;
...
}xq.plugin.MacroPlugin=xq.Class(xq.plugin.Base,{isEventListener:function(){return true
},onAfterLoad:function(A){this.xed=A;
this.xed.config.macroIds=[];
this.layers=[]
},onEditorStartInitialization:function(B){this.xed.validator.addListener(this);
this.xed.macroFactory=new xq.macro.Factory(this.xed.config.imagePathForContent+"placeholder.gif");
for(var A=0;
A<this.xed.config.macroIds.length;
A++){this.xed.macroFactory.register(this.xed.config.macroIds[A])
}B.timer.register(this.updateLayers.bind(this),100);
B.timer.register(this.updateLayerList.bind(this),2000)
},attachMacro:function(C){var A=C.getAttribute("longdesc")||C.longdesc;
var E=JSON.parse(unescape(A));
var D=this.xed.macroFactory.createMacroFromDefinition(E);
var B=new xq.Layer(this.xed,C,D.createHtml());
D.onLayerInitialzied(B);
this.layers.push(B)
},isAttachedPlaceHolder:function(B){for(var A=0;
A<this.layers.length;
A++){if(this.layers[A].element===B){return true
}}return false
},updateLayerList:function(){if(this.xed.getCurrentEditMode()!=="wysiwyg"){for(var A=0;
A<this.layers.length;
A++){this.layers[A].detach()
}this.layers=[]
}else{var B=xq.getElementsByClassName(this.xed.rdom.getRoot(),"xqlayer",xq.Browser.isTrident?"img":null);
for(var A=0;
A<B.length;
A++){if(!this.isAttachedPlaceHolder(B[A])){this.attachMacro(B[A])
}}}},updateLayers:function(){if(this.xed.getCurrentEditMode()!=="wysiwyg"){return 
}for(var B=0;
B<this.layers.length;
B++){var A=this.layers[B];
if(A.isValid()){A.updatePosition()
}else{A.detach();
this.layers.splice(B,1)
}}},onValidatorPreprocessing:function(A){var B=xq.compilePattern("<(IFRAME|SCRIPT|OBJECT|EMBED)\\s+[^>]+(?:/>|>.*?</(?:IFRAME|SCRIPT|OBJECT|EMBED)>)","img");
A.value=A.value.replace(B,function(E,C){var D=this.xed.macroFactory.createMacroFromHtml(E);
return D?D.createPlaceHolderHtml():""
}.bind(this))
},onValidatorAfterStringValidation:function(A){var C=/<img\s+[^>]*class="xqlayer"\s+[^>]*\/>/mg;
var B=/<img\s+[^>]*longdesc="(.+?)"\s+[^>]*\/>/m;
A.value=A.value.replace(C,function(D){var F=JSON.parse(unescape(D.match(B)[1]));
var E=this.xed.macroFactory.createMacroFromDefinition(F);
return E.createHtml()
}.bind(this))
}});
xq.macro.FlashMovieMacro=xq.Class(xq.macro.Base,{initFromHtml:function(){this.params.html=this.html
},initFromParams:function(){if(!xq.macro.FlashMovieMacro.recognize(this.params.html)){throw"Unknown src"
}},createHtml:function(){return this.params.html
}});
xq.macro.FlashMovieMacro.recognize=function(A){var B={tvpot:/http:\/\/flvs\.daum\.net\/flvPlayer\.swf\?/,youtube:/http:\/\/(?:www\.)?youtube\.com\/v\//,pandoratv:/http:\/\/flvr\.pandora\.tv\/flv2pan\/flvmovie\.dll\?/,pandoratv2:/http:\/\/imgcdn\.pandora\.tv\/gplayer\/pandora\_EGplayer\.swf\?/,mncast:/http:\/\/dory\.mncast\.com\/mncastPlayer\.swf\?/,yahoo:/http:\/\/d\.yimg\.com\//,mgoon:/http:\/\/play\.mgoon\.com\/Video\//,slideshare:/http:\/\/static\.slideshare\.net\/swf\//,vimeo:/http:\/\/(?:www\.)?vimeo\.com\/moogaloop\.swf\?/,storyq:/http:\/\/filefarm\.storyq\.net\/SlideView\.swf\?/,mandki:/http:\/\/www\.mandki\.com\/mandki\/viewer\.swf\?/,andu:/http:\/\/andu\.hanafos\.com\/home\/play\/playgw\.asp\?/,plaync:/http:\/\/static\.plaync\.co\.kr\/plaza\/pcc\/view\/viewskin\_s\.swf\?movie\_id\=/,naver:/http:\/\/serviceapi\.nmv\.naver\.com\/flash\/NFPlayer\.swf\?vid\=/};
for(var C in B){if(A.match(B[C])){return true
}}return false
};
xq.plugin.FlashMovieMacroPlugin=xq.Class(xq.plugin.Base,{onAfterLoad:function(A){A.config.macroIds.push("FlashMovie");
A.config.defaultToolbarButtonGroups.insert.push({className:"movie",title:"Movie",handler:"xed.handleMovie()"});
A.handleInsertMovie=function(B){var D=this.macroFactory.createMacroFromDefinition({id:"FlashMovie",params:{html:B}});
if(D){var C=D.createPlaceHolderHtml();
this.rdom.insertHtml(C);
var E=this.editHistory.onCommand();
this._fireOnCurrentContentChanged(this)
}else{alert("Unknown URL pattern")
}return true
};
A.handleMovie=function(){var B=new xq.ui.FormDialog(this,xq.ui_templates.basicMovieDialog,function(D){},function(E){this.focus();
if(xq.Browser.isTrident){var D=this.rdom.rng();
D.moveToBookmark(C);
D.select()
}if(!E){return 
}this.handleInsertMovie(E.html)
}.bind(this));
if(xq.Browser.isTrident){var C=this.rdom.rng().getBookmark()
}B.show({position:"centerOfEditor"});
return true
...
xq.macro.IFrameMacro=xq.Class(xq.macro.Base,{initFromHtml:function(){this.params.html=this.html
},initFromParams:function(){if(this.params.html){return 
}var C=[];
C.push("<iframe");
for(var A in this.params){var B=this.params[A];
if(B){C.push(" "+A.substring("p_".length)+'="'+B+'"')
}}C.push("></iframe>");
this.params={html:C.join("")}
},createHtml:function(){return this.params.html
}});
xq.macro.IFrameMacro.recognize=function(A){var B=xq.compilePattern("<IFRAME\\s+[^>]+(?:/>|>.*?</(?:IFRAME)>)","img");
return !!A.match(B)
};
xq.plugin.IFrameMacroPlugin=xq.Class(xq.plugin.Base,{onAfterLoad:function(A){A.config.macroIds.push("IFrame");
A.config.defaultToolbarButtonGroups.insert.push({className:"iframe",title:"IFrame",handler:"xed.handleIFrame()"});
A.handleIFrame=function(){var B=new xq.ui.FormDialog(this,xq.ui_templates.basicIFrameDialog,function(C){},function(E){this.focus();
if(!E){return 
}var D=this.macroFactory.createMacroFromDefinition({id:"IFrame",params:E});
if(D){var C=D.createPlaceHolderHtml();
this.rdom.insertHtml(C)
...
xq.macro.JavascriptMacro=xq.Class(xq.macro.Base,{initFromHtml:function(){var A=xq.compilePattern("src=[\"'](.+?)[\"']","img");
this.params.url=A.exec(this.html)[1]
},initFromParams:function(){if(!xq.macro.JavascriptMacro.isSafeScript(this.params.url)){throw"Unknown src"
}},createHtml:function(){return'<script type="text/javascript" src="'+this.params.url+'"><\/script>'
},onLayerInitialzied:function(A){A.getDoc().write(this.createHtml())
}});
xq.macro.JavascriptMacro.recognize=function(B){var C=xq.compilePattern("<SCRIPT\\s+[^>]*src=[\"']([^\"']+)[\"'][^>]*(?:/>|>.*?</(?:SCRIPT)>)","img");
var A=C.exec(B);
if(!A||!A[1]){return false
}return this.isSafeScript(A[1])
};
xq.macro.JavascriptMacro.isSafeScript=function(B){var A={googleGadget:/http:\/\/gmodules\.com\/ig\/ifr\?/img};
for(var C in A){if(B.match(A[C])){return true
}}return false
};
xq.plugin.JavascriptMacroPlugin=xq.Class(xq.plugin.Base,{onAfterLoad:function(A){A.config.macroIds.push("Javascript");
A.config.defaultToolbarButtonGroups.insert.push({className:"script",title:"Script",handler:"xed.handleScript()"});
A.handleInsertScript=function(B){var F={url:B};
var D=this.macroFactory.createMacroFromDefinition({id:"Javascript",params:F});
if(D){var C=D.createPlaceHolderHtml();
this.rdom.insertHtml(C);
var E=this.editHistory.onCommand();
this._fireOnCurrentContentChanged(this)
...
A.handleScript=function(){var B=new xq.ui.FormDialog(this,xq.ui_templates.basicScriptDialog,function(D){},function(E){this.focus();
if(xq.Browser.isTrident){var D=this.rdom.rng();
D.moveToBookmark(C);
D.select()
}if(!E){return 
}this.handleInsertScript(E.url)
}.bind(this));
if(xq.Browser.isTrident){var C=this.rdom.rng().getBookmark()
}B.show({position:"centerOfEditor"});
return true
