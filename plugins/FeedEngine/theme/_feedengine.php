...
<form method="post" onsubmit="Ajax.Updater('homepage-box', this.action, { method: 'post', parameters: { feed_url : $('feed_url').value } }); return false;" action="<?=url_for('feedengine', 'add', array('url' => urlencode($_SERVER['REQUEST_URI'])))?>" id="feed-form">
<h2><?=i('Homepage')?></h2>
<div id="homepage-box">
