...
<ul id="nav">
	<li><?=link_to(i('Center'), 'admin' )?></li>
	<li><?=link_to(i('Boards'), 'admin', 'board')?></li>
	<li><?=link_to(i('Users'), 'admin', 'user')?></li>
	<li><?=link_to(i('Settings'), 'admin', 'setting')?></li>
	<li><?=link_to(i('Plugins'), 'admin', 'plugin')?></li>
