...
<dl>
	...
	<?=check_box('board', 'always_show_comments', $board->get_attribute('always_show_comments', false))?> <label for="always_show_comments">댓글달기 권한이 없어도 댓글 내용은 보여줍니다.</label></dd>
	...
	<?=check_box('board', 'always_show_thumbnail', $board->get_attribute('always_show_thumbnail', false))?> <label for="always_show_thumbnail">첨부파일 권한이 없어도 썸네일은 보여줍니다.</label></dd>
</dl>
